...
def run_pipeline(MSA_file_path, print_file_content=False, output_path=None, number_of_nodes_to_evaluate=5):
    ...
    results = evaluate_top_splits(phylogenetic_tree_path, cov_mat_path, normalized_mean_embeddings_path, output_path=significant_splits_output_path, k=number_of_nodes_to_evaluate, target_pca_variance=0.99, standardize=True)
